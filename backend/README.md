...
## Project Structure
    ...
    ├── fragrant_silence_de_92798  # Django project configurations
...
1. Clone this repo and `cd fragrant_silence_de_92798`
...
2. Clone this repo and `cd fragrant_silence_de_92798`
